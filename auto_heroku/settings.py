# Django settings for auto_heroku project.
import os
...
SECRET_KEY = 'vg(wxthi-j^3)^q(m3ccahbn8(ueri(3rhi86p7)8qbx-&amp;%bkd'
...
ROOT_URLCONF = 'auto_heroku.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'auto_heroku.wsgi.application'
...
MAKAHIKI_HEROKU_KEY = env('MAKAHIKI_HEROKU_KEY', '')
